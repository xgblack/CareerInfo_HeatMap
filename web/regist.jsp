...
<head>
    ...
    <script>
        ...
        function checkEmail() {
            ...
            if (flag) {
                //邮箱合格
                s_email.innerHTML = "<img width='25' height='25' src='img/right.png'/>";
            } else {
                //两次密码不一致
                s_email.innerHTML = "<img width='25' height='25' src='img/error.png'/>邮箱格式不正确";
            }
            return flag;
        }
        function checkTel() {
            ...
            if (flag) {
                //邮箱合格
                s_tel.innerHTML = "<img width='25' height='25' src='img/right.png'/>";
            } else {
                //两次密码不一致
                s_tel.innerHTML = "<img width='25' height='25' src='img/error.png'/>手机号格式不正确";
            }
            return flag;
        }
